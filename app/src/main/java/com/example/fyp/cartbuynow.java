...
public class cartbuynow extends AppCompatActivity {
    EditText address;
    EditText phoneNo;
    EditText Name;
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cartbuynow);
...
//        renewItems(v);
    ...
    private List<cartData> getCartData() {
        dialog.show();
       // my_recycler_view.setHasFixedSize(true);
      final   List<cartData>  ProductData2 = new ArrayList<>();
       DatabaseReference myData = FirebaseDatabase.getInstance().getReference();
        myData.child("MyCart").child(firebaseAuth.getUid()).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        Log.i("getoreas3", "*************");
                        cartData i = snapshot.getValue(cartData.class);
                        ProductData2.add(i);
                    }
                }
//                iFirebaseLoadListener.onFirebaseLoadSuccess(itemGroups);
    ...
    public List<cartData> getCartData2() {
        //Rview.setHasFixedSize(true);
        //cartDataList.clear();
        //Rview.invalidate();
        // recreate();
     final    List<cartData> cartDataList=new ArrayList<>();
     DatabaseReference   CartData = FirebaseDatabase.getInstance().getReference();
    ...
    public void getORderIntent() {
            ...
            orderD.setProductlist(getCartData());
             //   Toast.makeText(getApplicationContext(), "ordersize="+orderD.getProductlist().size(), Toast.LENGTH_SHORT).show();
        ...
        public void addToMyORders(String id, String address, String name, String Number, String timeStamp) {
            ...
            View contextView = Main2Activity.contentMain;
